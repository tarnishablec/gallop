...
export const LockedProxyError = new Error('can not set new propty locked object')

export const NotUpdatableError = new Error('props can only be used on updatable element')